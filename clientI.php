...
<?php 
    ...
    <main>
        ...
        <form action="clientI.php" method="post">
            ...
            <div class="form-div">
                ...
                <input type="password" id="mdp1" name="mdp" placeholder="Mot de passe"  required oninput="verift()">
    ...
    <script>
         function verift(){
            let mdp1 = document.getElementById("mdp1").value.length ;
            let mdp = document.getElementById("mdp");
            if (mdp1!== 8){
                mdp.textContent = "Entrer un mot de passe de 8 caracteres";
        }
       }
    </script>
