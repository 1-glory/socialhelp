            ...
            <div class="content">
              <!--  <div class="filters">
                    ...
                    <select id="statusFilter" onchange="filterTable()">
                        ...
                        <option value="Annulée">Annulée</option>Non Valider
                        <option value="Effectuée">Effectuée</option>
                        <option value="Non Validée">Non Valider</option>
